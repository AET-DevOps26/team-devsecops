			...
			val authenticatedRequest =
				org.springframework.web.reactive.function.client.ClientRequest
					...
					.body { outputMessage, context ->
						val bodyDecorator =
							object : org.springframework.http.client.reactive.ClientHttpRequestDecorator(outputMessage) {
								override fun writeWith(
									body: org.reactivestreams.Publisher<out org.springframework.core.io.buffer.DataBuffer>,
