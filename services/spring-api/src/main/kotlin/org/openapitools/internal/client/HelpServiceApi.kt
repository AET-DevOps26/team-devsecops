...
interface HelpServiceApi {
     ...
     *  - 400: Invalid request payload syntax or corrupted internal header data (e.g. non-numeric timestamp)
     ...
     */
    @POST("ai/help")
    fun aiHelpPost(@Header("X-Internal-Timestamp") xInternalTimestamp: kotlin.String, @Header("X-Internal-Signature") xInternalSignature: kotlin.String, @Body helpRequestForwarded: HelpRequestForwarded): Call<HelpResponse>
