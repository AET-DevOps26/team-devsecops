...
data class Recipe(
	...
	@Schema(example = "null", required = true, description = "")
	@get:JsonProperty("ingredients", required = true) val ingredients: kotlin.collections.List<kotlin.String>,
	@Schema(example = "null", required = true, description = "")
	...
	@field:Valid
	@Schema(example = "null", required = true, description = "")
	@get:JsonProperty("nutrients", required = true) val nutrients: RecipeNutrients,
)
