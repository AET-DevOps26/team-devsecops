export const DE = {
	translation: {
		...
		recipe: {
			...
			helpPlaceholder:
        'Frag etwas zu diesem Rezept (z. B. nach einer Alternative, einer Technik oder einer Beilage)',
			thinking: 'Denkt nach…',
		...
		save: {
			...
			unsavedTitle: 'Rezept im Kochbuch speichern?',
			toLibrary: 'Im Kochbuch speichern',
			keepDraft: 'Als Entwurf behalten',
		},
	},
} as const
